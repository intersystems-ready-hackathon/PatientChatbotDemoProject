...
- [Title](https://usconfluence.iscinternal.com/spaces/ISCDACH/pages/1083872180/ChatFHIR+-+GenAI+MCP+FHIR#ChatFHIRGenAI,MCP,FHIR-Titel)
- [Abstract](https://usconfluence.iscinternal.com/spaces/ISCDACH/pages/1083872180/ChatFHIR+-+GenAI+MCP+FHIR#ChatFHIRGenAI,MCP,FHIR-Abstract)
- [Presentation](https://usconfluence.iscinternal.com/spaces/ISCDACH/pages/1083872180/ChatFHIR+-+GenAI+MCP+FHIR#ChatFHIRGenAI,MCP,FHIR-Presentation)
- [Github Repository](https://usconfluence.iscinternal.com/spaces/ISCDACH/pages/1083872180/ChatFHIR+-+GenAI+MCP+FHIR#ChatFHIRGenAI,MCP,FHIR-GithubRepository)
- [Useful Background Information](https://usconfluence.iscinternal.com/spaces/ISCDACH/pages/1083872180/ChatFHIR+-+GenAI+MCP+FHIR#ChatFHIRGenAI,MCP,FHIR-UsefulBackgroundInformation)
- [Demo](https://usconfluence.iscinternal.com/spaces/ISCDACH/pages/1083872180/ChatFHIR+-+GenAI+MCP+FHIR#ChatFHIRGenAI,MCP,FHIR-Demo)
    - [Necessary preparation](https://usconfluence.iscinternal.com/spaces/ISCDACH/pages/1083872180/ChatFHIR+-+GenAI+MCP+FHIR#ChatFHIRGenAI,MCP,FHIR-NotwendigeVorbereitung)
    - [Important URLs](https://usconfluence.iscinternal.com/spaces/ISCDACH/pages/1083872180/ChatFHIR+-+GenAI+MCP+FHIR#ChatFHIRGenAI,MCP,FHIR-WichtigeURLs)
    - [Command to create a container snapshot](https://usconfluence.iscinternal.com/spaces/ISCDACH/pages/1083872180/ChatFHIR+-+GenAI+MCP+FHIR#ChatFHIRGenAI,MCP,FHIR-KommandozumErzeugeneinesContainerSnapshots)
    - [Script](https://usconfluence.iscinternal.com/spaces/ISCDACH/pages/1083872180/ChatFHIR+-+GenAI+MCP+FHIR#ChatFHIRGenAI,MCP,FHIR-Skript)
        - [Scenario 1 - LLM with connection to iris-mcp (still without transformation for drugs)](https://usconfluence.iscinternal.com/spaces/ISCDACH/pages/1083872180/ChatFHIR+-+GenAI+MCP+FHIR#ChatFHIRGenAI,MCP,FHIR-Szenario1-LLMmitVerbindungzuiris-mcp\(nochohneTransformationf%C3%BCrMedikamente\))
        - [Scenario 2 - Complement medication mapping in SQL Builder and MCP Server](https://usconfluence.iscinternal.com/spaces/ISCDACH/pages/1083872180/ChatFHIR+-+GenAI+MCP+FHIR#ChatFHIRGenAI,MCP,FHIR-Szenario2-Erg%C3%A4nzendesMappingsvonMedikamentenimSQLBuilderundMCPServer)
        - [Scenario 3 - Deleting the SQL Builder Configuration and Basic Building from Scratch](https://usconfluence.iscinternal.com/spaces/ISCDACH/pages/1083872180/ChatFHIR+-+GenAI+MCP+FHIR#ChatFHIRGenAI,MCP,FHIR-Szenario3-L%C3%B6schenderKonfigurationdesSQLBuildersundgrundlegenderAufbauvonGrundauf)
        - [Scenario 4 - (Optional if there is still time) - Various queries that demonstrate different capabilities](https://usconfluence.iscinternal.com/spaces/ISCDACH/pages/1083872180/ChatFHIR+-+GenAI+MCP+FHIR#ChatFHIRGenAI,MCP,FHIR-Szenario4-\(Optional,wennnochZeitist\)-VerschiedeneAbfragen,dieverschiedeneF%C3%A4higkeitendemonstieren)

# Title

ChatFHIR: GenAI meets FHIR, agent-based data access with MCP
...
- Open SQL Portal: [http://localhost:8080/csp/sys/exp/%25CSP.UI.Portal.SQL.Home.zen?$NAMESPACE=CHATFHIR](http://localhost:8080/csp/sys/exp/%25CSP.UI.Portal.SQL.Home.zen?$NAMESPACE=CHATFHIR)
- Schema: Select "ChatFHIR"
- Expand tables
- Briefly explain that we currently see 3 relevant tables here with patient master data, observations and conditions.
- Drag the ChatFHIR.Patient table to the "Run Query" tab
- Click Run
...
- Switch to VS Code
- Open file iris\projects\CHATFHIR\SampleMessages\StefanKoch.rest
- Click on the "Send Request" link
- Open Production in the Management Portal: [http://localhost:8080/csp/healthshare/chatfhir/EnsPortal.ProductionConfig.zen?PRODUCTION=Demo.CHATFHIR.Interop.Production&$NAMESPACE=CHATFHIR](http://localhost:8080/csp/healthshare/chatfhir/EnsPortal.ProductionConfig.zen?PRODUCTION=Demo.CHATFHIR.Interop.Production&$NAMESPACE=CHATFHIR)
...
- Health → ChatFHIR → FHIR Server Management → Go 
- Links Select FHIR SQL Builder (2nd from bottom)
- Under "Transformation Specifications" click the edit icon of the "ChatFHIRTransform" transformation
...
- Select Repository Configuration on the left (2nd from above)
    - Delete repository
    - Delete credentials for ChatFHIRUser
- Click on "Home" in the top right corner
- System Explorer → SQL → Go
- Change namespace to ChatFHIR
- Expand schema dropdown
- Tell that there is no ChatFHIR schema and therefore no tables
- Expand tables
- No more ChatFHIR tables
...
- Import Transformation
    - Select the chat-fhir\iris\projects\CHATFHIR\SetupRequestBodies\transformspec_with_med.body file.
    - Analysis: ChatFHIRRepo
    - Click "Import"
    - Click Edit icon and show that the transform is now import.
    - Click "Done"
- Create projection:
    - FHIR Repository: ChatFHIRRepo
    - Transformation Specification: ChatFHIRTRansform
    - Package Name: ChatFHIR
